                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text"  id="datepicker-action"  value="{{$teacher->joining_date}}" name="joining_date" data-date-format="yyyy-mm-dd"  >
                                    </div>
                                    @error('joining_date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <button class="btn btn-success btn-lg nextBtn btn-lg pull-right" type="submit">{{trans('teacher_trans.submit')}}</button>
                    </form>
                        </div>
                    </div>
                </div>
