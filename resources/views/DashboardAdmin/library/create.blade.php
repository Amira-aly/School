...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{ trans('library_trans.add_book') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}" class="default-color">{{ trans('main_trans.main') }}</a></li>
                <li class="breadcrumb-item active">{{ trans('library_trans.add_book') }}</li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('library.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-success nextBtn btn-lg pull-right" type="submit">{{ trans('library_trans.submit') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
