            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('online_zoom.create')}}" class="btn btn-success btn-lg" role="button" aria-pressed="true" style="margin-bottom: 10px;">{{ trans('zoom_trans.add_online_zoom') }}</a>
                                <a class="btn btn-warning btn-lg" href="{{route('indirect.create')}}" style="margin-bottom: 10px;">{{ trans('zoom_trans.add_offline_zoom') }}</a>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($online_zooms as $online_zoom)
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Delete_receipt{{$online_zoom->meeting_id}}" ><i class="fa fa-trash"></i></button>
                                            </td>
                                            </tr>
                                        @include('DashboardAdmin.zooms.delete')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
