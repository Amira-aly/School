                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id">{{ trans('exam_trans.subject_name') }}: <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="teacher_id">{{ trans('exam_trans.Name_Teacher') }}  : <span class="text-danger">*</span></label>
