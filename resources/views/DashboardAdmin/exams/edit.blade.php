...
@section('page-header')
 ...
 <div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{ trans('exam_trans.edit_exam') }} {{$exam->name}}</h4> <span></span>
        </div>
        <div class="col-sm-6">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('exams.update','test')}}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label >{{ trans('exam_trans.subject_name') }} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label >{{ trans('exam_trans.Name_Teacher') }} : <span class="text-danger">*</span></label>
                                ...
                                <button class="btn btn-success btn-lg nextBtn  pull-right" type="submit">{{ trans('exam_trans.edit') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
