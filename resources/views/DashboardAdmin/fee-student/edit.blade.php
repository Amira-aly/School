        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form action="{{route('fees_student.update','test')}}" method="POST" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4"> {{ trans('fee_trans.name_student') }}</label>
                                <input type="text" value="{{$fee_invoices->student->name}}" readonly name="title" class="form-control">
