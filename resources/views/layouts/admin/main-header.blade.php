 ...
 <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL('/dashboard')}}">{{ trans('main_trans.Dashboard') }}</a>
        <a class="navbar-brand brand-logo-mini"><img src="assets/images/logo-icon-dark.png"></a>
    </div>
    <!-- Top bar left -->
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30 ml-20">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                ...
                <img src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlcnxlbnwwfHwwfHw%3D&w=1000&q=80" alt="avatar">
            </a>
            <div class="dropdown-menu dropdown-menu-right ">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{route('profile.index')}}"><i class="text-warning ti-user"></i> {{ trans('main_trans.profile') }}</a>
